...
public class Lyra extends Character implements Heal, GetChest{
    private double coin, maxHp;
    private int level;
    Lyra(String username, double hp, double attackPower, double coin, int level,boolean alive, double maxHp){
