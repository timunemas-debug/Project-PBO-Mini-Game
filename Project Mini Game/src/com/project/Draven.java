...
import com.project.Character.GetChest;;

public class Draven extends Character implements Heal, GetChest {
    private double maxHp, coin;
    private int level;
    Draven(String username, double hp, double attackPower, double coin, int level,boolean alive, double maxHp){
    ...
    public void getChest(){
        System.out.println("Selamat anda mendapatkan Senjata baru!");
        System.out.println("Senjata Baru!");
    }
